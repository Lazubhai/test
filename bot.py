...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        # Send exact error to user for debugging (remove in production)
...
async def select_habit(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if routines:
        ...
        keyboard = [
            [InlineKeyboardButton("Yes", callback_data='1'), InlineKeyboardButton("No", callback_data='0')]
        ]
        reply_markup = InlineKeyboardMarkup(keyboard)
...
async def handle_reward(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if choice == "yes":
        ...
        await query.message.reply_text("On a scale of 1 to 10, how satisfying was your reward? Please send a number between 1 and 10.")
